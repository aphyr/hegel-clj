...
(deftest vector-test
  (run-test! {:test-cases 10}
             (g/let [any    (g/vector (g/one-of (g/float) (g/integer)))
...
(deftest list-test
  (run-test! {:test-cases 10}
             (g/let [any    (g/list (g/one-of (g/float) (g/integer)))
...
(deftest set-test
  (run-test! {:test-cases 10}
             (g/let [any    (g/set (g/one-of (g/float) (g/integer)))
...
(deftest map-test
  (run-test! {:test-cases 10}
             (g/let [m     (g/map (g/integer) (g/set (g/float)))
